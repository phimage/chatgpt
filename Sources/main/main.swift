...
struct Cmd: ParsableCommand {
    ...
    @Option(name: [.long, .short] , help: "The model used, default: text-davinci-003")
    var model: String = "text-davinci-003"

    @Option(name: [.long, .short] , help: "The maximum number of tokens to generate in the completion. Default 4000")
